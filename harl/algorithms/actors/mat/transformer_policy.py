import torch
import numpy as np
from harl.utils.mat_util import update_linear_schedule
from harl.utils.mat_util import get_shape_from_obs_space, get_shape_from_act_space
from harl.utils.mat_util import check
from harl.algorithms.actors.mat.ma_transformer import MultiAgentTransformer
...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, num_agents, device=torch.device("cpu")):
        ...
        if self.algorithm_name in ["mat", "mat_dec"]:
            from harl.algorithms.actors.mat.ma_transformer import MultiAgentTransformer as MAT
        else:
    ...
    def restore(self, model_dir):
        ...
        if "lora" in self.algorithm_name:
            unloaded=self.transformer.load_state_dict(transformer_state_dict, strict=False)
