...
class SharedReplayBuffer(object):
    ...
    def __init__(self, args, num_agents, obs_space, cent_obs_space, act_space, env_name):
        ...
        self.hidden_size = args['model']['hidden_sizes'][0]
        ...
        self._use_popart =args['algo']['use_popart']
        self._use_valuenorm = args['train']['use_valuenorm']
        self._use_proper_time_limits = args['train']['use_proper_time_limits']
        self.algo = args['model']['algorithm_name']
