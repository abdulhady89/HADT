...
class ManyGroundStationWorldModel(BasicWorldModel):
    ...
    @default_args(
        groundStationsData=[
            ...
            # Oceania
            # dict(name="Darwin", lat=-12.4572, long=130.8366, elev=28),
            ...
            # AWS:
            dict(name="Alaska", lat=61.2181, long=-149.9003, elev=31),
            dict(name="Bahrain", lat=26.2235, long=50.5876, elev=9),
            dict(name="Cape Town", lat=-33.9249, long=18.4241, elev=25),
            dict(name="Dubbo", lat=-32.2432, long=148.6051, elev=275),
            dict(name="Hawai", lat=21.3069, long=-157.8583, elev=12),
            dict(name="Ireland", lat=53.3498, long=-6.2603, elev=20),
            dict(name="Ohio", lat=39.9612, long=-82.9988, elev=275),
            dict(name="Oregon, USA", lat=45.5152, long=-122.6784, elev=15),
            dict(name="Punta Arenas", lat=-52.9415, long=-70.8488, elev=37),
            dict(name="Seoul", lat=37.5665, long=126.9780, elev=38),
            dict(name="Singapore", lat=1.3521, long=103.8198, elev=15),
            dict(name="Stockholm", lat=59.3293, long=18.0686, elev=28)
        ],
        groundLocationPlanetRadius=orbitalMotion.REQ_EARTH * 1e3,
        gsMinimumElevation=np.radians(10.0),
        gsMaximumRange=-1,
    ...
    def setup_ground_locations(
        ...
        **kwargs,
        ...
        #     self.visualize_ground_station(groundStation)
